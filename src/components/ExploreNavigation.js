...
function ExploreNavigation(props) {
  ...
  return (
    <>
      <nav className="w-screen px-0 h-[64px] bg-[#111111] opacity-70 text-white border-t border-[#111111] flex items-center justify-center xs:justify-between  md:items-start md:w-[72px] md:h-screen md:py-8 md:px-2 md:border-t-0 md:border-r md:flex-col md:justify-between xl:w-[240px]">
        <div
          className="m-0 md:mx-auto px-0 xl:m-0 xl:px-4 hover:cursor-pointer"
          onClick={() => {
            navigate('/');
          }}
        >
          <svg
            ...
            className="w-[48px] h-[48px] fill-white scale-[0.8] m-0 md:mx-auto lg:mx-0 xl:hidden"
          >
        ...
        <ul className="flex md:flex-col md:w-full">
          <li>
            ...
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                className="h-6 w-6 fill-[#ffffff] group-hover:scale-[110%]"
              >
                <path
              ...
              <p className="hidden pl-4 text-white group-active:font-bold group-focus:font-bold xl:block">
                Images
              </p>
            </NavLink>
          </li>
          <li>
            ...
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                className="h-6 w-6 fill-white group-hover:scale-[110%]"
              >
                <path
                  className={`group-active:hidden group-focus:hidden ${
        ...
        >
          ...
          <p className="hidden pl-4 text-white group-active:font-large group-focus:font-large xl:block">
            More
          </p>
        </button>
      </nav>
      ...
      >
        <Card className="w-[240px] h-[48px] fixed right-[16px] bottom-[70px] md:left-[16px] flex">
          <CardActions className="w-full h-full flex justify-between items-center">
            <Logout />
            <IconButton onClick={handleMenu} sx={{ color: '#111111' }}>
              <CloseIcon />
            </IconButton>
          </CardActions>
        </Card>
