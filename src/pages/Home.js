...
const HomePage = () => {
  ...
  return (
    <div className="mx-auto my-auto 2xs:m-auto flex justify-center items-center basis-2 ">
      ...
      <div className="my-auto mx-auto 2xs:mx-4 flex flex-col items-center w-screen 2xs:w-[320px] border-0 xs:border-2 xs:border-[#ffffff50] px-2 py-8 rounded-xl xs:bg-black xs:bg-opacity-10 xs:backdrop-blur-lg xs:drop-shadow-lg text-white grow">
