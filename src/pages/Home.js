...
const HomePage = () => {
  ...
  return (
    <div className="mx-auto my-auto 2xs:m-auto flex justify-center items-center basis-2 ">
      <div className="hidden relative h-[500px] w-[250px] my-2 md:block ">
        <img
          src={mobFrame}
          alt="phone frame"
          className="w-[250px] h-[500px] absolute top-0 left-0"
        />
        <img
          src={images[currentImageIndex].src}
          alt={images[currentImageIndex].alt}
          className="w-[94%] h-[96%] absolute top-2 left-2 z-[-10] "
        />
      </div>
      <div className="my-auto mx-auto 2xs:mx-4 flex flex-col items-center w-screen 2xs:w-[320px] border-0  px-2 py-8 rounded-xl xs:bg-black xs:bg-opacity-70 xs:drop-shadow-xl text-white grow">
